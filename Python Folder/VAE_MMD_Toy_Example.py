...
if __name__ == '__main__':
  ...
  plt.savefig("Inference Fit for Toy Example (MMD).png")
  ...
  plt.tight_layout()
  plt.savefig("VAE Traceplot Toy Example (MMD).png")
  ...
  plt.savefig("VAE Effective Sample Size Toy Example (MMD).png")
  ...
  ax.xaxis.set_tick_params(labelsize=15)
  ax.xaxis.set_ticks(np.arange(-0.01,0.03,0.01))
  ax.set_xlabel('$\hat{R}$', fontsize = 15)
  ax.set_title('$\hat{R}$ of MCMC', fontsize = 20)
  plt.savefig("VAE Rhat Toy Example (MMD).png")
