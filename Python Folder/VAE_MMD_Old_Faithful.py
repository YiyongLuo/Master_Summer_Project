...
if __name__ == '__main__':
    ...
    #### stan code
    sm = pystan.StanModel(file='VAE_SB_Stan_old_faithful_MMD.stan')
    ...
    plt.savefig('Inference Fit for Old Faithful (MMD).png')
    ...
    plt.tight_layout()
    plt.savefig("VAE Traceplot Old Faithful (MMD).png")
    ...
    plt.savefig("VAE Effective Sample Size Old Faithful (MMD).png")
    ...
    ax.xaxis.set_tick_params(labelsize=15)
    ax.xaxis.set_ticks(np.arange(0,15,5))
    ax.set_xlabel('$\hat{R}$', fontsize = 15)
    ax.set_title('$\hat{R}$ of MCMC', fontsize = 20)
    plt.savefig("VAE Rhat Old Faithful (MMD).png")
